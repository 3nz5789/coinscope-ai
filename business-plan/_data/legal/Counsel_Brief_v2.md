...
> **Sync note (2026-05-01):** Reconciled to canonical Track B framework — see `business-plan/_decisions/decision-log.md`. Three updates applied to this v2 vs. the originally-uploaded v2:
> 1. Tier prices updated to locked Track B values (Free $0 / Trader $79 / Desk Preview $399 / Desk Full v2 $1,199 + per-seat $149/$249) — see §1.2 and §3.1 below.
> 2. Target user profile reconciled to locked Phase-0 ICP definition.
> 3. "Team tier" reference (KYC gating) clarified as Desk Full v2 tier per Track B tier-naming lock.
...
- Subscription billing through Stripe with four tiers: **Free ($0) / Trader ($79/mo) / Desk Preview ($399/mo) / Desk Full v2 ($1,199/mo + per-seat $149 partner read-only / $249 analyst).** Annual paid-yearly carries ~17% discount; founder-cohort pricing (~25–30% off) applies during a time-bounded 60-day post-public-launch window per Track B §6.6 lock.
...
- KYC / AML pipeline activation. KYC is architected (Sumsub or Persona) but gated to the future Desk Full v2 tier.
...
- Profile (locked Track B Phase-0): **disciplined retail futures traders, $5k–$250k account size, MENA + global English, self-directed.** Secondary persona: prop-firm-funded traders. Anti-ICP: US-resident retail (regulatory), sub-$5k accounts (unit economics), copy-traders / signal-group buyers (wrong job-to-be-done), fund LPs (we tool the manager, not the LP).
...
- Subscription terms: pricing (4 tiers — Free $0 / Trader $79 / Desk Preview $399 / Desk Full v2 $1,199 + per-seat $149/$249, per Track B §6.6 lock), billing cadence (monthly + annual paid-yearly with ~17% discount), taxes, auto-renewal, cancellation, refunds. Counsel should advise on compliance with consumer-subscription regimes in UAE, EU, UK.
...
| KYC records (future, Desk Full v2 tier) | User upload | Sumsub / Persona | Per regulator | Sumsub or Persona |
...
- KYC / AML scoping for Desk Full v2 tier (Sumsub or Persona).
