> **ARCHIVED 2026-05-01.** This is an earlier monolithic business-plan draft. **Superseded by the 18-section v1 framework** in `business-plan/` (sections §1–§16). Retained for historical traceability. Do not act on this file — every load-bearing decision (tier names, prices, leverage cap, ICP definition, persona structure) was renegotiated during the 2026-05-01 walkthrough and is documented in `_decisions/decision-log.md`. Notable changes: tier names changed from Intelligence/Co-pilot/Managed to Free/Trader/Desk; leverage cap changed from 20x to 10x; D1–D8 decisions all closed.
...
- **Risk architecture:** Max DD 10%, daily loss 5%, max leverage 20x, max 3 open positions, position heat cap 80%. Kill switch in place.
