> **ARCHIVED 2026-05-01.** Superseded by **Counsel_Brief_v2** (now in `_data/legal/`, with prices and ICP definition reconciled to canonical Track B framework). Retained for historical traceability.
