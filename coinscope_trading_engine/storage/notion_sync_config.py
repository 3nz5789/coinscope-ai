...
Fields: Trade, Pair, Direction, Status, Signal Score, Conviction,
        Regime at Entry, MTF at Entry, Entry Price, Entry Time,
        Stop Loss, Take Profit 1/2, Exit Price, Exit Time,
        Size USDT, Leverage, Kelly Pct Used, RR Planned, RR Actual,
        PnL USDT, PnL Pct, Mistakes, Lessons
"""

SIGNAL_LOG_DB_ID = "ed9457ff-78f7-4008-bc28-ef3046506039"
"""
Signal Log database (rebuilt 2026-04-04).
Fields: Signal, Pair, Direction, Score (0-12), Strength Label,
...
Fields: Scan ID, Scan Timestamp, Pairs Scanned, Signals Found,
        Min Score Used, Avg Score, Top Signal, Top Score,
        BTC Regime, BTC Price, Market Regime, Engine Mode, Notes
"""
