...
importers:
  ...
  .:
    dependencies:
      ...
      zustand:
        specifier: ^5.0.12
        version: 5.0.12(@types/react@19.2.1)(react@19.2.1)(use-sync-external-store@1.6.0(react@19.2.1))
    devDependencies:
...
snapshots:
  ...
  '@tanstack/react-query@5.99.1(react@19.2.1)':
    dependencies:
      '@tanstack/query-core': 5.99.1
      react: 19.2.1
